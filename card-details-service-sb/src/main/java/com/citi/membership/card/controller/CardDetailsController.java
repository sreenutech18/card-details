...
import com.citi.membership.card.validator.CardDetailsRequestValidator;
...
public class CardDetailsController {
	...
	@Autowired
	CardDetailsRequestValidator requestValidator;
	...
	public CardDetailsResponse getCardDetails(@PathVariable("cardNum") String cardNum,
			@RequestHeader(name = "clientId", required = true) String clientId,
			@RequestHeader(name = "requestId", required = true) String requestId,
			@RequestHeader(name = "msgTs", required = true) String msgTs) throws CardDetailsReqValidationExcep {
		
		
		requestValidator.validateRequest(cardNum);
